...
export const participantPlanCreateSchema = z.object({
  ...
  coordinatorUserId: objectIdSchema,
...
export const participantPlanListQuerySchema = paginationQuerySchema.extend({
  ...
  coordinatorUserId: objectIdSchema.optional(),
  serviceAgreementStatus: z.enum(["draft", "pending", "signed", "expired"]).optional()
});
...
export const shiftNoteCreateSchema = z.object({
  ...
  reviewStatus: z.enum(["pending", "reviewed", "needs_changes"]).default("pending")
});
...
export const complianceRecordCreateSchema = z.object({
  ...
  status: z.enum(["compliant", "expiring", "expired", "missing"]).default("missing"),
  expiryDate: z.coerce.date().optional(),
...
export const participantCreateSchema = z.object({
  ...
  state: stateEnum,
  status: z.enum(["active", "inactive", "on_hold", "discharged"]).default("active")
});
