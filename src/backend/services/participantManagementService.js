...
export async function createParticipant({ currentUser, payload }) {
    ...
    const participant = await Participant.create({
        ...
        primaryDisability: payload.primaryDisability,
        secondaryDisability: payload.secondaryDisability,
        medicalAlerts: payload.medicalAlerts,
        highRiskFlags: payload.highRiskFlags,
        epilepsyProtocol: payload.epilepsyProtocol,
        emergencyContact: payload.emergencyContact,
        ndisNumber: payload.ndisNumber,
        state: payload.state,
        managementType: payload.managementType,
        staffRatio: payload.staffRatio,
