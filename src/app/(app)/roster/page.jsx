...
export default async function RosterPage() {
      ...
      <Card>
        <CardContent className="pt-5">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Select a company from sidebar `Companies` to view roster management.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <ComingSoonPanel
      ...
      description="Roster management module is under development. This workspace will open for the selected company."
    />
  );
}