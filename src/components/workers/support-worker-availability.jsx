  ...
  return {
    ...
    rangeStart:
      typeof input.rangeStart === "string"
        ...
        : fallback.rangeStart,
    rangeEnd:
      typeof input.rangeEnd === "string" ? input.rangeEnd : fallback.rangeEnd,
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View/Edit your current availability or set it up if it has not been
            saved yet.
          </CardDescription>
        </CardHeader>
